...
begin
  zmiana_statusu_rezerwacji3(105, 'Z');
end;
...
UPDATE REZERWACJE SET STATUS='A' WHERE NR_REZERWACJI = 105;

UPDATE WYCIECZKI SET LICZBA_WOLNYCH_MIEJSC = 1 WHERE ID_WYCIECZKI=1;
